...
public class InteligenciaAtaqueDañoDoble extends Inteligencia {

	protected Arma arma;
	
	public InteligenciaAtaqueDañoDoble(Arma a) {
		super();
		arma = a;
	}
	...
	public void atacar(Entidad e) {
		...
		if (Gdx.input.isKeyPressed(Keys.SPACE) && lapso) {
			...
			Flecha flecha = new Flecha(posDisp,arma.getDaño()*2);
			flecha.setDisparo("flechaFuego", 4, 0.5f);
